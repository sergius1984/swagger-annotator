...
**swagger-annotator** — утилита командной строки, которая поддерживает документацию API в актуальном состоянии.
...
- ✍️ генерирует или обновляет комментарии в формате [swaggo/swag](https://github.com/swaggo/swag).
